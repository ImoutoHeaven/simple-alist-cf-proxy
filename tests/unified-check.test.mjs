  ...
  globalThis.fetch = async () => ({
    ...
    json: async () => [{
      ...
      cache_link_data: JSON.stringify({
        ...
        download: {
          provider: 'test',
          ticket: 'test-ticket-unified-log-abcdefghijklmnopqrstuvwxyz',
      ...
      cache_version: '11111111-1111-4111-8111-000000000008',
      rate_access_count: 3,
...
test('readTicketState sends ticket hash and no legacy idle fields', async () => {
  ...
  globalThis.fetch = async (url, options) => {
    ...
    return {
      ...
      json: async () => [{
        ...
        idle_lease_expires_at: 1710000300,
        idle_renew_owner_lease_id: '11111111-1111-1111-1111-111111111111',
        idle_renew_owner_last_heartbeat_at: 1710000200,
        ip_hash: 'ip-hash',
        path_hash: 'path-hash',
      }],
    };
  ...
  try {
    ...
    assert.deepEqual(result, {
      ...
      idlePolicy: 'renewable',
      idleLeaseExpiresAt: 1710000300,
      idleRenewOwnerLeaseId: '11111111-1111-1111-1111-111111111111',
      idleRenewOwnerLastHeartbeatAt: 1710000200,
      ipHash: 'ip-hash',
      pathHash: 'path-hash',
    });
  } finally {
